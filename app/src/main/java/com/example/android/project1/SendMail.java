...
public class SendMail extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Toast.makeText(context,"Сообщение отправлено. Проверьте почту.",Toast.LENGTH_LONG).show();
    }
    ...
    public static void sendEmail(Context context, String userEmail, String subject, String message) {
        //Getting content for email
//        String email = userEmail;
//        String subjectText = subject;
//        String messageText = message;
        //String subject = "Подтверждение почты";
        //String message = "Для подтверждения почты, введите в приложении код \n " + code;
