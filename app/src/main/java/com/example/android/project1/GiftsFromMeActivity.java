...
public class GiftsFromMeActivity extends AppCompatActivity {
    private TextView category, giftsForMe, giftsFromMe;
    private ImageButton backBtn;
    private FirebaseDatabase database;
    private DatabaseReference mydatabase;
    private RecyclerView recyclerView;
    private List<Present> presentsFromMe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gifts_from_me);
        ...
        category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GiftsFromMeActivity.this, GiftsActivity.class);
        ...
        giftsForMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GiftsFromMeActivity.this, GiftsForMeActivity.class);
                startActivity(intent);
            }
        });
        ...
        giftsFromMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GiftsFromMeActivity.this, GiftsFromMeActivity.class);
                startActivity(intent);
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GiftsFromMeActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        recyclerView = (RecyclerView)findViewById(R.id.presents_from_me);
        recyclerView.setHasFixedSize(true);
        LinearLayoutManager llm = new LinearLayoutManager(this);
        llm.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(llm);

        presentsFromMe = new ArrayList<>();
    ...
    private void updateList(){
        PresentAdapter.OnPresentClickListener onPresentClickListener = new PresentAdapter.OnPresentClickListener() {
            ...
            public void onPresentClick(Present present) {
                ...
                Intent intent = new Intent(GiftsFromMeActivity.this, PresentActivity.class);
                startActivity(intent);
            }
        };

        presentAdapter = new PresentAdapter(presentsFromMe, onPresentClickListener);
